...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<c:url value='/css/egovframework/story/font-awesome.min.css' />" />
	<link rel="stylesheet" href="<c:url value='/css/egovframework/story/jquery-ui.css' />">
	<link rel="stylesheet" href="<c:url value='/css/egovframework/story/holdon.min.css' />">
	...
	<script src="<c:url value='/js/egovframework/story/holder.js' />"></script>
	<script src="<c:url value='/js/egovframework/story/holdon.min.js' />"></script>
	<!--[if lt IE 9]>
